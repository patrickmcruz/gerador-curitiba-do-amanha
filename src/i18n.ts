...
const translationEN = {
  "app": {
    "title": "Hypervisor - Curitiba of Tomorrow"
  },
  "header": {
    "title": "Hypervisor <1>Curitiba of Tomorrow</1>",
    "subtitle": "Upload your own image to see Curitiba re-imagined by AI"
  },
  "footer": {
    "text": "Developed by Hypervisor / IPPUC. An exploration of AI-driven creativity."
  },
  "settings": {
  ...
  "scenarios": [
    { "label": "Optimistic", "value": "Optimistic", "description": "Clean energy, sustainable architecture, lush green spaces, and advanced public transportation." },
    { "label": "Pessimistic", "value": "Pessimistic", "description": "Pollution, urban decay, overpopulation, and a lack of green spaces." }
  ],
  "promptSuggestions": {
...
const translationPTBR = {
  ...
  "scenarios": [
    { "label": "Otimista", "value": "Otimista", "description": "Energia limpa, arquitetura sustentável, áreas verdes exuberantes e transporte público avançado." },
    { "label": "Pessimista", "value": "Pessimista", "description": "Poluição, decadência urbana, superpopulação e falta de espaços verdes." }
  ],
  "promptSuggestions": {
